 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://44.193.24.117:8080/SOAP?service=LoginService")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://tempuri.org/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://44.193.24.117:8080/SOAP?service=LoginService");
    ...
    public LoginService getLoginServicePort() {
        return super.getPort(new QName("http://tempuri.org/", "LoginServicePort"), LoginService.class);
    }
    ...
    public LoginService getLoginServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "LoginServicePort"), LoginService.class, features);
    }
